...
export const STRINGS = {
  en: {
    ...
    'nb.ca.h': 'Canada: thirteen answers, and one of them is “no”',
    'nb.ca.cap': 'Québec only. Each line is placed at the autoroute’s measured centre position in this atlas.',
    'nb.ca.ladder': 'What each jurisdiction actually publishes',
    'nb.ca.lv.codified': 'In regulation',
    'nb.ca.lv.stated': 'Ministry-stated',
    'nb.ca.lv.observed': 'Pattern only',
    'nb.ca.lv.denied': 'Officially denied',
    'nb.ca.lv.none': 'Unnumbered',
    ...
    'tlx.note': 'The mileage and the curve are FHWA’s figures for the whole Interstate System, recorded at the end of every year from 1960 to 1997. After 1997 the series stops and the curve holds; later years on the playhead are there because other dated openings exist, not because FHWA kept counting. The map can show less than the curve: nobody published an opening date for each Interstate, so only the {n} routes whose completion year is documented in this atlas appear, out of {total}. Québec’s ministry did publish per-tronçon opening years — {qc} of them, 1958–2025, from the Répertoire des autoroutes. Those years surface as notes on the playhead. They do not light the map: the directory names each tronçon in words, not coordinates, and drawing a whole autoroute in the year its first piece opened would show unopened road as open. The faint lines underneath are the Interstate network as it stands today, drawn so that a route lighting up can be placed on the continent — not a claim about what was open in the year on the playhead.',
  ...
  zh: {
    ...
    'nb.ca.h': '加拿大：十三套答案，其中一套是“没有”',
    'nb.ca.cap': '仅魁北克。每条线的位置来自该高速公路在本图谱中的实测中心坐标。',
    'nb.ca.ladder': '各省区实际公布了什么',
    'nb.ca.lv.codified': '写进法规',
    'nb.ca.lv.stated': '交通部公开说明',
    'nb.ca.lv.observed': '仅为观察到的模式',
    'nb.ca.lv.denied': '官方明确否认',
    'nb.ca.lv.none': '没有编号公路',
    ...
    'tlx.why': '这两个数字的区别',
    'tlx.close': '退出建成过程视图',
    'tlx.note': '里程与曲线取自联邦公路管理局对整个州际公路系统的统计，1960 至 1997 年逐年记录。1997 年之后该序列停止，曲线持平；播放头上更晚的年份是因为另有有据可查的通车记录，不是因为联邦公路管理局还在计数。地图能显示的少于此数：逐条州际公路的通车日期从未公开发布，因此只有本站收录了确切建成年份的 {n} 条路线会出现，而系统共有 {total} 条。魁北克交通部按路段公布了通车年份——Répertoire des autoroutes 中 {qc} 段，1958 至 2025 年。这些年份作为播放头上的记载出现，并不点亮地图：名录用文字描述每一段，没有坐标；若在第一段通车那年点亮整条高速公路，就会把尚未开通的路画成已通车。底层的暗色细线是今日州际路网的全貌，用于给亮起的路线提供地理参照，并不表示该年份已有这些路段通车。',
